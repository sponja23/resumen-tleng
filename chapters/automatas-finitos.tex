...
\begin{theorem*}
    Dado un AFND $M = \langle Q, \Sigma, \delta, q_0, F \rangle$, existe un AFD $M' = \langle Q', \Sigma, \delta', q_0', F' \rangle$ tal que $\L(M) = \L(M')$.
\end{theorem*}
\begin{proof}
